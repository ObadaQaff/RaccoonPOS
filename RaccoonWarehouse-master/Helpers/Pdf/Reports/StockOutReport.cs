...
{
    public class StockOutReportDocument : BaseReportDocument
    {
        private readonly StockDocumentReadDto _doc;

        public StockOutReportDocument(StockDocumentReadDto doc)
        {
            _doc = doc;
        }

        public override string ArabicTitle => "سند إخراج بضاعة";
        public override string EnglishTitle => "Stock Out Document";
